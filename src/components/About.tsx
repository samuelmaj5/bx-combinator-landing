...
const About = () => {
  ...
  const features = [
    "Meet like-minded students every two weeks",
    "Events with founders, VCs, and mentors", 
    "Build projects from ideas to startups",
    "Get feedback and share your goals",
    "Network with ambitious peers",
    "Change the French mindset toward innovation"
  ];
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            {features.map((feature, index) => (
              <AnimatedBulletPoint key={index} delay={index * 0.1}>
                {feature}
              </AnimatedBulletPoint>
            ))}
          </div>
