      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {quotes.map((quoteData, index) => <div key={index} className="bg-card/70 rounded-2xl p-8 border border-border shadow-elegant hover:shadow-glow transition-all duration-300 hover:-translate-y-1">
